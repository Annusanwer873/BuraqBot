...
def processRequest(req):
    ...
    if (intent == 'Get Promotional Emails'):
        ...
        cust_email = 'annusanwer873@gmail.com'
        ...
        return {
            ...
            str2 = str.format(link="https://buraqbot.herokuapp.com/abaya")
        ...
        str = "Please Proceed to our BuraqStore Recommendation engine through given link \n {link} \n Enter 1 for main menu and 0 to exit the chat, Thanks. !!!"
        str2 = str.format(link="https://buraqbot.herokuapp.com/men-Tshirt")
        ...
        str = "Please Proceed to our BuraqStore Recommendation engine through given link \n {link} \n Enter 1 for main menu and 0 to exit the chat, Thanks. !!!"
        str2 = str.format(link="https://buraqbot.herokuapp.com/fullsleevesmen-Tshirt")
        ...
        str = "Please Proceed to our BuraqStore Recommendation engine through given link \n {link} \n Enter 1 for main menu and 0 to exit the chat, Thanks. !!!"
        str2 = str.format(link="https://buraqbot.herokuapp.com/Mensformalshirts")
        ...
        str = "Please Proceed to our BuraqStore Recommendation engine through given link \n {link} \n Enter 1 for main menu and 0 to exit the chat, Thanks. !!!"
        str2 = str.format(link="https://buraqbot.herokuapp.com/Menskurta")
        ...
        str = "Please Proceed to our BuraqStore Recommendation engine through given link \n {link} \n Enter 1 for main menu and 0 to exit the chat, Thanks. !!!"
        str2 = str.format(link="https://buraqbot.herokuapp.com/bottom")
        ...
        str = "Please Proceed to our BuraqStore Recommendation engine through given link \n {link} \n Enter 1 for main menu and 0 to exit the chat, Thanks. !!!"
        str2 = str.format(link="https://buraqbot.herokuapp.com/Loafers")
        ...
        str = "Please Proceed to our BuraqStore Recommendation engine through given link \n {link} \n Enter 1 for main menu and 0 to exit the chat, Thanks. !!!"
        str2 = str.format(link="https://buraqbot.herokuapp.com/formal-shoes")
        ...
        str = "Please Proceed to our BuraqStore Recommendation engine through given link \n {link} \n Enter 1 for main menu and 0 to exit the chat, Thanks. !!!"
        str2 = str.format(link="https://buraqbot.herokuapp.com/boots")
        ...
        return {
            ...
            str = "Please Proceed to our BuraqStore Recommendation engine through given link \n {link} \n Enter 1 for main menu and 0 to exit the chat, Thanks. !!!"
            str2 = str.format(link="https://buraqbot.herokuapp.com/lawn-collection")
            ...
            str = "Please Proceed to our BuraqStore Recommendation engine through given link \n {link} \n Enter 1 for main menu and 0 to exit the chat, Thanks. !!!"
            str2 = str.format(link="https://buraqbot.herokuapp.com/EmbroideredCollection")
            ...
            str = "Please Proceed to our BuraqStore Recommendation engine through given link \n {link} \n Enter 1 for main menu and 0 to exit the chat, Thanks. !!!"
            str2 = str.format(link="https://buraqbot.herokuapp.com/Wintercollection")
            ...
            str = "Please Proceed to our BuraqStore Recommendation engine through given link \n {link} \n Enter 1 for main menu and 0 to exit the chat, Thanks. !!!"
            str2 = str.format(link="https://buraqbot.herokuapp.com/PretCollection")
            ...
            str = "Please Proceed to our BuraqStore Recommendation engine through given link \n {link} \n Enter 1 for main menu and 0 to exit the chat, Thanks. !!!"
            str2 = str.format(link="https://buraqbot.herokuapp.com/WesternStyleKurti")
            ...
            str = "Please Proceed to our BuraqStore Recommendation engine through given link \n {link} \n Enter 1 for main menu and 0 to exit the chat, Thanks. !!!"
            str2 = str.format(link="https://buraqbot.herokuapp.com/Bridals")
            ...
            str = "Please Proceed to our BuraqStore Recommendation engine through given link \n {link} \n Enter 1 for main menu and 0 to exit the chat, Thanks. !!!"
            str2 = str.format(link="https://buraqbot.herokuapp.com/facecare")
            ...
            str = "Please Proceed to our BuraqStore Recommendation engine through given link \n {link} \n Enter 1 for main menu and 0 to exit the chat, Thanks. !!!"
            str2 = str.format(link="https://buraqbot.herokuapp.com/facecleansers")
            ...
            str = "Please Proceed to our BuraqStore Recommendation engine through given link \n {link} \n Enter 1 for main menu and 0 to exit the chat, Thanks. !!!"
            str2 = str.format(link="https://buraqbot.herokuapp.com/FaceTreatment")
            ...
            str = "Please Proceed to our BuraqStore Recommendation engine through given link \n {link} \n Enter 1 for main menu and 0 to exit the chat, Thanks. !!!"
            str2 = str.format(link="https://buraqbot.herokuapp.com/haircare")
            ...
            str = "Please Proceed to our BuraqStore Recommendation engine through given link \n {link} \n Enter 1 for main menu and 0 to exit the chat, Thanks. !!!"
            str2 = str.format(link="https://buraqbot.herokuapp.com/Bath&Shower")
            ...
            str = "Please Proceed to our BuraqStore Recommendation engine through given link \n {link} \n Enter 1 for main menu and 0 to exit the chat, Thanks. !!!"
            str2 = str.format(link="https://buraqbot.herokuapp.com/Body")
...
def abaya():
    try:
        ...
        return render_template('review.html',
                               tables=[buraq_Scrapped.to_html(classes='data')],
                               titles=buraq_Scrapped.columns.values,
